...
1. **Start at README.md** - High-level overview with links to major sections
2. **Browse [[Concept Index]]** - Complete categorized listing
3. **Follow links** - Each page links to related content
...
- `meeting_saved_closed_caption.txt` - Full transcript
- `meeting_saved_new_chat.txt` - Chat log
